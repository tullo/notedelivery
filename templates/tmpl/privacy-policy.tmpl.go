...
<p>
  If you encounter any problems, or have any questions, then feel free to <a href="https://github.com/tullo/note.delivery/issues/new" target="_blank">open an issue on GitHub</a>.
</p>
{{ end }}
`
